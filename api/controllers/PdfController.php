...
class PdfController {
    ...
    public function generate($id) {
        ...
        try {
            ...
            $watermarkText = 'Generated by InvoQuote <br> Product of Deviqo Software Solutions';

            $html = '<!DOCTYPE html><html><head><meta charset="utf-8"><style>
                body { font-family: "Helvetica", sans-serif; font-size: 13px; color: #333; position: relative; }
                .watermark { position: fixed; bottom: 15px; left: 50%; transform: translateX(-50%); text-align: center; font-size: 13px; color: #000; opacity: 0.26; letter-spacing: 0.08em; pointer-events: none; z-index: 100; }
            ...
            </style></head><body><div class="watermark">' . $watermarkText . '</div>';
            ...
            $html .= '<table class="details-table"><tr><td><strong>Bill To:</strong><br>'.htmlspecialchars($document['customer']['company_name'] ?? '').'<br>'.nl2br(htmlspecialchars($document['customer']['billing_address'] ?? '')).'</td><td style="text-align: right;"><div class="doc-title">'.$docTitle.'</div><strong>No:</strong> '.htmlspecialchars($document['document_number']).'<br><strong>Date:</strong> '.htmlspecialchars($document['issue_date']).'';

            if (($type === 'invoice' || $type === 'receipt') && !empty($document['po_number'])) {
                $html .= '<br><strong>PO-NO:</strong> ' . htmlspecialchars($document['po_number']);
            }
            ...
            if (!empty($document['terms_conditions'])) $html .= '<strong>Terms & Conditions:</strong><br>'.nl2br(htmlspecialchars($document['terms_conditions'])).'<br><br>';
